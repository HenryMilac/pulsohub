            ...
            <div class="flex flex-col">
                <div class="flex justify-between">
                    ...
                    <div class="relative inline-block mt-2" x-data="{ open: false }">
                        ...
                        {{-- Buttons --}}
                        <div x-show="open" @click.away="open = false" class="absolute right-0 bg-gray-100 rounded-lg shadow-xl border border-gray-300 z-10 py-3 px-4 space-y-2 w-auto min-w-fit" style="width: auto; min-width: max-content;">
